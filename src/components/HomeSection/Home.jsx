                ...
                <header className="flex justify-between items-center p-5 w-full">
                    ...
                    <nav className="space-x-4">
                        <ul className="flex space-x-12 text-white cursor-pointer">
                            ...
                            <li className="btn-head-l mx-[5px]"><a href="log-res.html" className="bg-white py-1.5 px-6 text-black rounded-full shadow-[0px_20px_24px_0px_rgba(0,0,0,0.08)]">Login</a></li>
                            <li className="btn-head-s mx-[5px]"><a href="log-res.html" className="bg-white/30 py-1.5 px-6 text-white rounded-full shadow-[0px_20px_24px_0px_rgba(0,0,0,0.08)]">Sign Up</a></li>
                        </ul>
                    </nav>
